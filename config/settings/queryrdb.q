...
hdbdir:hsym `$getenv[`KDBQUERYHDB]                                //the location of the hdb directory
...
sortcsv:hsym first .proc.getconfigfile["querysort.csv"] //location of csv file
...
\d .servers
CONNECTIONS:`queryhdb`querygateway    // list of connections to make at start up
