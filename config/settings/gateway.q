...
\d .servers
CONNECTIONS:`rdb`hdb`wdb,.ds.rdbtypes,.ds.tailreadertypes	// list of connections to make at start up
...
\d .ds
subscribers:`rdb,.ds.rdbtypes,.ds.tailreadertypes    // list of subscribers to retrieve access tables from. Can be list of proctypes or procnames
