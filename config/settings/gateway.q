...
\d .servers
CONNECTIONS:`rdb`rdb_seg1`rdb_seg2`hdb`tr_seg1`tr_seg2	// list of connections to make at start up
...
\d .ds
subscribers:`rdb_seg1`rdb_seg2`tr_seg1`tr_seg2    // list of subscribers to retrieve access tables from. Can be list of proctypes or procnames
