...
inputcsv:getenv[`KDBCONFIG],"/filealerter.csv"			// The name of the input csv to drive what gets done
polltime:0D00:00:10						// The period to poll the file system	
alreadyprocessed:getenv[`KDBCONFIG],"/filealerterprocessed"	// The location of the table on disk to store the information about files which have already been processed
