...
.pm.adduser[`dqc;`local;`md5;md5"pass"]
.pm.assignrole[`dqc;`systemuser]
.pm.addtogroup[`dqc;`systemuser]
.pm.adduser[`dqe;`local;`md5;md5"pass"]
.pm.assignrole[`dqe;`systemuser]
.pm.addtogroup[`dqe;`systemuser]
