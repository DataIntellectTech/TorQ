...
- Custom
  ...
  As part of these new changes it is important to note that if the STP process goes down and is restarted, the stp will open new log files in the existing log directory and will not immediately replay the previous log files.
