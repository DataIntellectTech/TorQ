...
readtableproperties:{[tablepropertiepath]
  ...
  table:table,raze {[alltable;x]![alltable;();0b;(enlist`proctype)!enlist(enlist x)]}[alltable;] each `hdb`rdb,.ds.rdbtypes,.ds.tailreadertypes;       //join rdb, hdb, tailreader entries for any "all" or blank entries 
