...
readtableproperties:{[tablepropertiepath]
  ...
  table:table,raze {[alltable;x]![alltable;();0b;(enlist`proctype)!enlist(enlist x)]}[alltable;] each `hdb`rdb`rdb_seg1`rdb_seg2`tr_seg1`tr_seg2;      //insert rdb, hdb, tr_seg1, tr_seg2 entries for any "all" or blank entries 
