...
endofdaysort:{[dir;pt;tablist]
	...
	.[.os.ren;(string .Q.par[dir;pt;`];`$1_string .Q.par[hdbdir;pt;`]);{.lg.e[`mvtohdb;"Failed to move data from pdb to hdb directory"]}];
...
starttimer:{[]
	$[@[value;`.timer.enabled;0b];
		...
		.timer.repeat[.z.p;0Wp;settimer;(`.wdb.savetodisk;`);"save wdb data to disk"];
