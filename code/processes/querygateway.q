...
update {x[`tables]:distinct x[`tables],`data;x} each attributes from `.gw.servers where servertype=`queryhdb
update attributes:{[x;d] update date:d from x}'[attributes;2 cut -1+.z.d-til 6] from `.gw.servers where servertype=`queryhdb
...
// rdb only
neg[h](`.gw.asyncexec;"`$last .z.x";`queryrdb);h[]
...
neg[h](`.gw.asyncexec;"`$last .z.x";`tables`servertype!(enlist`logmsg;`queryrdb));h[]
h(`.gw.syncexec;"`$last .z.x";`queryrdb)
h(`.gw.syncexec;"`$last .z.x";enlist[`tables]!enlist enlist`trade)
h(`.gw.syncexec;"`$last .z.x";`tables`servertype!(enlist`logmsg;`queryrdb))

// hdb only
neg[h](`.gw.asyncexec;"`$last .z.x";`queryhdb);h[]
...
neg[h](`.gw.asyncexec;"`$last .z.x";`tables`servertype`date!(enlist`data;`queryhdb;enlist .z.d-5));h[]
h(`.gw.syncexec;"`$last .z.x";`queryhdb)
...
h(`.gw.syncexec;"`$last .z.x";`tables`servertype`date!(enlist`data;`queryhdb;enlist .z.d-5))

// rdb + hdb
neg[h](`.gw.asyncexec;"`$last .z.x";`queryrdb`queryhdb);h[]
neg[h](`.gw.asyncexec;"`$last .z.x";enlist[`servertype]!enlist`queryrdb`queryhdb);h[]
neg[h](`.gw.asyncexec;"`$last .z.x";`tables`servertype!(enlist`logmsg;`queryrdb`queryhdb));h[]
neg[h](`.gw.asyncexec;"`$last .z.x";enlist[`date]!enlist .z.d-til 7);h[]
h(`.gw.syncexec;"`$last .z.x";`queryrdb`queryhdb)
h(`.gw.syncexec;"`$last .z.x";enlist[`servertype]!enlist`queryrdb`queryhdb)
h(`.gw.syncexec;"`$last .z.x";`tables`servertype!(enlist`logmsg;`queryrdb`queryhdb))
h(`.gw.syncexec;"`$last .z.x";enlist[`date]!enlist .z.d-til 7)

// errors
neg[h](`.gw.asyncexec;"`$last .z.x";enlist[`tables]!enlist enlist`logmsgXXX);h[]
neg[h](`.gw.asyncexec;"`$last .z.x";`tables`servertype!(enlist`data;`queryrdb`queryhdb));h[]
neg[h](`.gw.asyncexecjpt;(`.q.system;"sleep 10");enlist[`servertype]!enlist`queryrdb`queryhdb;raze;();0D00:00:03);h[]
h(`.gw.syncexec;"`$last .z.x";enlist[`tables]!enlist enlist`logmsgXXX)
h(`.gw.syncexec;"`$last .z.x";`tables`servertype!(enlist`data;`queryrdb`queryhdb))
