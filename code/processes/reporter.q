...
activereports:{select from reports where (.z.d mod 7) in/: daysofweek, end>.z.t};
...
dtsuffix:{ssr[;;"_"]/["_" sv string .z.d,.z.t;".:"]};
...
emailreport:{[temppath;recipients;filename;filetype;data]
    ...
    subject:"Report '",(string data`name),"' has been generated by TorQ [",(string .z.d),"]";
