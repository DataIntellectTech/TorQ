...
$[(count runtimes)=0;
	...
	[{[runtime].timer.rep[$[.proc.ft[]>.z.d+runtime;1D+`timestamp$.z.d+runtime;`timestamp$.z.d+runtime];0Wp;1D;(`hkrun`);0h;"run housekeeping";0b]} each runtimes;.lg.o[`housekeeping;"Housekeeping scheduled for: ", (" " sv string raze runtimes)]]]
