...
getstripemapping:{
    ...
    /- should change handle retrieval to use any striped proc (To-Do after config driven proctypes for rdb/tr)
    rdbhandle:$[count i:.servers.getservers[`proctype;`rdb_seg1;()!();1b;0b];first exec w from i;.lg.e[`getstripemapping;"Unable to retrieve RDB handle"]];
