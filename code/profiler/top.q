...
.dotz.set[`.z.ts;{@[{t:``pos _ select from .Q.prf0 p where not .Q.fqk each file;
...
$[null p:"I"$.z.x 0;[system"p 0W";.dotz.set[`.z.pg;{p::x;system"p 0";system"t 10"}];system qcmd," "sv string[(.z.f;"j"$system"p")],.z.x];system"t 10"]
