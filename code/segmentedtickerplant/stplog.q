...
endofperiod:{[p;rolllogs]
  ...
  .stpps.endp[.stplg`currperiod;.stplg`nextperiod;`proctype`procname`tables!(.proc.proctype;.proc.procname;exec table from .sub.SUBSCRIPTIONS where proctype=`segmentedtickerplant)];
...
endofday:{[p]
  ...
  .stpps.end[.eodtime.d;`proctype`procname`tables!(.proc.proctype;.proc.procname;exec table from .sub.SUBSCRIPTIONS where proctype=`segmentedtickerplant)];
