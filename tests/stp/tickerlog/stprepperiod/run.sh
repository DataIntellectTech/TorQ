...
q $TORQHOME/torq.q \
	...
	-.replay.tplogfile $KDBTESTS/stp/tickerlog/stprepperiod/testlogs/stprepperiod/ \
	-proctype tickerlogreplay -procname tickerlogreplay1 \
	-procfile $KDBAPPCONFIG/process.csv \
	-localtime \
	-.replay.schemafile $TORQHOME/database.q \
	-.replay.hdbdir $KDBTESTS/stp/tickerlog/stprepperiod/testhdb/ \
	-.replay.exitwhencomplete 0 \
	-.replay.segmentedmode 1 \
	-test $KDBTESTS/stp/tickerlog/stprepperiod/ \
	-debug
