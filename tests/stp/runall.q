...
results:0:[("PSIISSBSJJBBBB";enlist csv);`$getenv[`KDBTESTS],"/stp/results/results_",(raze "." vs string .z.d),".csv"];
errors:0:[("PSIISSBSJJBBB";enlist csv);`$getenv[`KDBTESTS],"/stp/results/errors_",(raze "." vs string .z.d),".csv"];
