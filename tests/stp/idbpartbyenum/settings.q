...
processcsv:getenv[`KDBTESTS],"/stp/idbpartbyenum/process.csv";
wdbdir:hsym `$getenv[`KDBTESTS],"/stp/idbpartbyenum/tempwdb/";
hdbdir:hsym `$getenv[`KDBTESTS],"/stp/idbpartbyenum/temphdb/";
testlogdb:"testlog";
