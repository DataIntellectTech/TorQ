...
.datadog.sendMetric:{[metric_name;metric_value] system -1"echo -n ","\"",metric_name,":",(string metric_value),"|g|","#shell\" | nc -4u -w0 127.0.0.1 ",$[count dogstatsd_port;string dogstatsd_port;"8125"];};
